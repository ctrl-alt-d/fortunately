Unfortunately is a open card game for amusing teaching several knowledge areas based on [Fortunately, Unfortunately game](https://en.wikipedia.org/wiki/Fortunately,_Unfortunately).
